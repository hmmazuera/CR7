...
st.set_page_config(page_title="Cristiano Ronaldo - Data Analysis App", layout="wide")

st.sidebar.title("Cristiano Ronaldo - Data Analysis App")
...
if selections == "Introduction":
    ...
    **Cristiano Ronaldo dos Santos Aveiro** is a Portuguese professional footballer who plays as a forward for Al-Nassr and captains the Portugal national team.
    ...
    sns.countplot(x='Opponent', data=df[df['Opponent'].isin(fav_opponents_df.index)], order=fav_opponents_df.index,
                  ax=ax)
